...
const Projects = () => {
  return (
    <div
      className="flex flex-col items-center justify-center pb-20 z-[30]"
      id="projects"
    >
      <h1 className="text-5xl underline font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 pb-10 pl-20">
        My Projects
      </h1>
